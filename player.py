...
class Player:
    ...
    def win_match(self, sets_won=2, points=0, delta_elo=0):
        self.matches_won += 1
    ...
    def lose_match(self, sets_won=0, points=0, delta_elo=0):
        self.matches_played += 1
        self.sets_won += sets_won
        self.points_won += points
        self.elo -= delta_elo

    def unwin_match(self, sets_won=2, points=0, delta_elo=0):
        self.matches_won -= 1
        self.matches_played -= 1
        self.sets_won -= sets_won
        self.points_won -= points
    ...
    def unlose_match(self, sets_won=0, points=0, delta_elo=0):
        self.matches_played -= 1
        self.sets_won -= sets_won
        self.points_won -= points
        self.elo += delta_elo
